...
if ( skip ) return;
    ...
    include.tag( "leaflet",
        { loader: "sequence", tags: [
            { loader: "script", url: "lib/leaflet/leaflet-1.7.1.js" },
            { loader: "style", url: "lib/leaflet/leaflet-1.7.1.css" },
            { loader: "script", url: "lib/leaflet/leaflet-geoman-2.11.2.min.js" },
            { loader: "style", url: "lib/leaflet/leaflet-geoman-2.11.2.css" },
            { loader: "script", url: "lib/leaflet/esri-leaflet-3.0.2.js" },
            { loader: "script", url: "lib/leaflet/esri-leaflet-renderers-2.1.2.js" },
...
( function () {
    ...
    function setupGlobalSMK() {
        return ( window.SMK = Object.assign( {
            ...
            BUILD: {
                commit:     '3d6d7265c6664b805057790417c3c74d3c5ded83',
                branch:     'search.then.identify',
                lastCommit: '2022-08-05 14:55:43 -0700',
                origin:     'https://github.com/bcgov/smk.git',
                version:    '1.1.1',
            },
